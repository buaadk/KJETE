...
def main(args):
    for split in ["train", "dev", "test"]:
        ...
        #with open('%s/bert_all_joint_matres/%s.pickle' % (args.data_dir, split), 'rb') as handle:
        with open('%s/bert_all_joint_commonse/%s.pickle' % (args.data_dir, split), 'rb') as handle:
        ...
        save_dir = args.data_dir + '/all_context_comsense_agg/'
